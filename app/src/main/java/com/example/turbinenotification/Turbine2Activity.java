...
public class Turbine2Activity extends AppCompatActivity {
    ...
    private void notification(){
        if (Build.VERSION.SDK_INT>= Build.VERSION_CODES.M){
            NotificationChannel channel = new NotificationChannel("k","k", NotificationManager.IMPORTANCE_DEFAULT);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this,"k")
                ...
                .setAutoCancel(true)
                .setContentText("Turbine 2 Data Updated");
